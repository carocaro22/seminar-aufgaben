...
void PrintMatrix(CMatrix& m) {
	...
	Serial.print(m.GetElement(0, 0), 2); Serial.print(" "); Serial.print(m.GetElement(0, 1), 2);Serial.print(" "); Serial.println(m.GetElement(0, 2), 2);
	Serial.print(m.GetElement(1, 0), 2); Serial.print(" "); Serial.print(m.GetElement(1, 1), 2);Serial.print(" "); Serial.println(m.GetElement(1, 2), 2);
  Serial.print(m.GetElement(2, 0), 2); Serial.print(" "); Serial.print(m.GetElement(2, 1), 2);Serial.print(" "); Serial.println(m.GetElement(2, 2), 2);
  Serial.println("");
	/*
