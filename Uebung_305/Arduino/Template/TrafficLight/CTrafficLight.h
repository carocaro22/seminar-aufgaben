/******************************************************************************
 * Declaration of the CTrafficLight class to abstract the traffic light       *
 * CTrafficLight.h                                                            *
 *                                                                            *
...
public:
  ...
  // --------------------------------------------------------------
  CTrafficLight() : m_u8Port_Red(10),
                    m_u8Port_Yellow(9),
                    m_u8Port_Green(8) {}
                    
  CTrafficLight(unsigned char ptRed, 
                unsigned char ptYellow, 
                unsigned char ptGreen) : m_u8Port_Red(ptRed),
...
private:
  ...
  unsigned char m_u8Port_Red;    // Pin number where the red LED is connected
  unsigned char m_u8Port_Yellow; // Pin number where the yellow LED is connected
  unsigned char m_u8Port_Green;  // Pin number where the green LED is connected
